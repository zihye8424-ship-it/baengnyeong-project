      ...
      <div className="rounded-3xl bg-white p-6 shadow-lg md:p-10">
        <div className="mb-8">
          ...
          <p className="mt-3 leading-7 text-gray-600">
            {placeName}을(를) 다녀온 경험과 여행 팁을 자유롭게 남겨주세요.
          </p>
        </div>

        <div className="rounded-3xl bg-slate-50 p-5 md:p-7">
          <label className="block">
            <span className="mb-2 block font-bold text-gray-800">닉네임</span>
            <input
              type="text"
              value={nickname}
          ...
          <div className="mt-5">
            <span className="mb-2 block font-bold text-gray-800">만족도</span>
            ...
            <p className="mt-2 text-sm font-bold text-amber-600">{rating}점</p>
          </div>

          <label className="mt-5 block">
            <span className="mb-2 block font-bold text-gray-800">방문 후기</span>
            <textarea
              value={content}
              onChange={(e) => setContent(e.target.value)}
              placeholder={`${placeName}에서 좋았던 점, 방문 시간, 준비물 등의 후기를 적어주세요.`}
              rows={5}
              maxLength={500}
