...
export const metadata = {
  title: "검은낭 해안 | 백령도의 모든 정보",
  description: "대청도 검은낭 해안의 볼거리와 방문 팁, 여행 포인트와 방문 리뷰를 확인하세요.",
};
...
export default function Page() {
  return (
    <PlaceTemplate
      ...
      image="/images/daecheong.jpg"
      badges={["해안절경", "자연여행", "대청도"]}
      quickFacts={[
        ["추천 대상", "가족 · 연인 · 자연여행"],
        ["추천 시간", "날씨가 좋은 낮 시간"],
    ...
    >
      <div className="space-y-8">
        <section className="rounded-3xl bg-white p-8 shadow-sm md:p-10">
          <h2 className="text-3xl font-black">🏝️ 검은낭 해안은 어떤 곳인가요?</h2>
          <div className="mt-6 space-y-5 leading-8 text-gray-700">
            <p>거친 바위와 서해가 어우러지는 대청도의 해안 경관입니다. 유명 관광지만 빠르게 지나가기보다 주변의 바다와 마을 풍경까지 함께 바라보면 섬의 분위기를 더 잘 느낄 수 있습니다.</p>
      ...
      <PlaceReviews placeSlug="geomeunnang-coast" placeName="검은낭 해안" />
    </PlaceTemplate>
  );
}
