...
export const metadata = {
  title: "노화동포구 | 백령도의 모든 정보",
  description: "소청도 노화동포구의 볼거리와 방문 팁, 여행 포인트와 방문 리뷰를 확인하세요.",
};
    ...
    >
      <div className="space-y-8">
        <section className="rounded-3xl bg-white p-8 shadow-sm md:p-10">
          <h2 className="text-3xl font-black">🏝️ 노화동포구은 어떤 곳인가요?</h2>
          <div className="mt-6 space-y-5 leading-8 text-gray-700">
            <p>바다와 주민의 생활이 맞닿아 있는 소청도의 작은 포구입니다. 유명 관광지만 빠르게 지나가기보다 주변의 바다와 마을 풍경까지 함께 바라보면 섬의 분위기를 더 잘 느낄 수 있습니다.</p>
      ...
      <PlaceReviews placeSlug="nohwa-port" placeName="노화동포구" />
    </PlaceTemplate>
  );
}
