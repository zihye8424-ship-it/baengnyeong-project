...
export const metadata = {
  title: "소청도 천주교회·김대건 신부상 | 백령도의 모든 정보",
  description: "소청도 소청도 천주교회·김대건 신부상의 볼거리와 방문 팁, 여행 포인트와 방문 리뷰를 확인하세요.",
};
...
export default function Page() {
  return (
    <PlaceTemplate
      ...
      subtitle="소청도의 종교·생활문화를 조용히 살펴보는 역사문화 방문지"
      image="/images/socheong.jpg"
      badges={["역사문화", "마을여행", "소청도"]}
      quickFacts={[
        ["추천 대상", "가족 · 연인 · 자연여행"],
        ["추천 시간", "날씨가 좋은 낮 시간"],
    ...
    >
      <div className="space-y-8">
        <section className="rounded-3xl bg-white p-8 shadow-sm md:p-10">
          <h2 className="text-3xl font-black">🏝️ 소청도 천주교회·김대건 신부상은 어떤 곳인가요?</h2>
          <div className="mt-6 space-y-5 leading-8 text-gray-700">
            <p>소청도의 종교·생활문화를 조용히 살펴보는 역사문화 방문지입니다. 유명 관광지만 빠르게 지나가기보다 주변의 바다와 마을 풍경까지 함께 바라보면 섬의 분위기를 더 잘 느낄 수 있습니다.</p>
      ...
      <PlaceReviews placeSlug="socheong-catholic" placeName="소청도 천주교회·김대건 신부상" />
    </PlaceTemplate>
  );
}
