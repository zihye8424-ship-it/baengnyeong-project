    ...
    >
      <div className="rounded-3xl bg-white p-8 shadow-sm md:p-10">
        ...
        <div className="mt-6 space-y-5 leading-8 text-gray-700">
          <p>
            백령도 여행에서는 아름다운 자연경관뿐 아니라 섬 곳곳에 남아
            있는 기독교의 흔적도 만나볼 수 있습니다. 오래된 교회와
            마을의 이야기를 따라가다 보면 백령도 주민들의 생활과 함께
            이어져 온 신앙문화를 자연스럽게 살펴볼 수 있습니다.
          </p>
        ...
        <div className="mt-6 grid gap-5 md:grid-cols-2">
          <div className="rounded-2xl bg-sky-50 p-6">
            ...
            <p className="mt-3 leading-7 text-gray-700">
              백령도의 기독교 역사를 이야기할 때 빼놓기 어려운
              장소로, 마을과 함께 이어져 온 교회 문화를 살펴보기
              좋습니다.
            </p>
          </div>
          ...
          <div className="rounded-2xl bg-sky-50 p-6">
            ...
            <p className="mt-3 leading-7 text-gray-700">
              백령도의 여러 마을에서 교회를 만날 수 있어 섬 주민들의
              생활 속에 이어져 온 신앙문화를 느껴볼 수 있습니다.
            </p>
          </div>
          ...
          <div className="rounded-2xl bg-sky-50 p-6">
            ...
            <p className="mt-3 leading-7 text-gray-700">
              교회는 예배 공간을 넘어 오랜 시간 마을 공동체와 함께해
              온 장소라는 점에서 백령도의 생활사를 이해하는 데
              의미가 있습니다.
            </p>
          </div>
          ...
          <div className="rounded-2xl bg-sky-50 p-6">
            ...
            <p className="mt-3 leading-7 text-gray-700">
              자연 명소 중심의 여행 일정에 교회와 역사문화 장소를
              더하면 백령도를 조금 다른 시선으로 둘러볼 수 있습니다.
            </p>
          </div>
        </div>
      </div>
      ...
      <div
        id="junghwadong"
        className="scroll-mt-24 rounded-3xl bg-white p-8 shadow-sm md:p-10"
      >
        <h2 className="text-3xl font-black">
        ...
        <div className="mt-6 space-y-5 leading-8 text-gray-700">
          ...
          <p>
            ...
            예배나 행사가 진행되는 시간에는 조용히 관람하고, 내부
            출입과 사진 촬영은 현장 안내를 먼저 확인하는 것이 좋습니다.
          </p>
        </div>
      </div>
      ...
      <div className="rounded-3xl bg-white p-8 shadow-sm md:p-10">
        ...
        <div className="mt-6 space-y-4 leading-8 text-gray-700">
          <p>
            ✅ 중화동교회만 보고 이동하기보다 주변 마을까지 함께
            둘러보면 백령도의 옛 생활 분위기를 느끼기 좋습니다.
          </p>

          <p>
            ✅ 교회는 관광지만이 아니라 실제 종교시설이므로 예배와
            행사가 진행 중일 때는 방문 예절을 지켜 주세요.
          </p>

          <p>
            ✅ 교회 내부를 촬영하고 싶다면 먼저 촬영 가능 여부를
            확인하는 것이 좋습니다.
          </p>
      ...
      <div className="rounded-3xl bg-white p-8 shadow-sm md:p-10">
        ...
        <p className="mt-4 leading-7 text-gray-600">
          아래 카드를 누르면 관련 내용이나 관광지 상세 페이지로
          이동합니다.
        </p>
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-3">
          <Link
            href="#junghwadong"
            className="block cursor-pointer rounded-2xl border-2 border-gray-200 bg-white p-5 transition-all duration-200 hover:-translate-y-1 hover:border-sky-500 hover:bg-sky-50 hover:shadow-lg"
          >
            ...
            <p className="mt-2 text-sm leading-6 text-gray-600">
              백령도의 교회 역사와 마을 신앙문화를 함께 살펴보기
              좋은 장소
            </p>
          </Link>

          <Link
            href="/place/christian-island"
      ...
      <div className="rounded-3xl bg-white p-8 shadow-sm md:p-10">
        ...
        <div className="mt-6 grid gap-5 md:grid-cols-2">
          ...
          <div className="rounded-2xl bg-slate-50 p-6">
            ...
            <p className="mt-3 leading-7 text-gray-700">
              한낮에는 더울 수 있으므로 실내외 일정을 적절히 나누고
              생수를 준비하세요.
            </p>
          </div>
          ...
          <div className="rounded-2xl bg-slate-50 p-6">
            ...
            <p className="mt-3 leading-7 text-gray-700">
              강풍과 추위에 대비하고 이동 전 교통과 시설 운영 상황을
              확인하세요.
            </p>
          </div>
        </div>
