...
export const metadata = {
  ...
  description: "부드러운 모래사장과 파도 풍경을 가까이에서 즐기기 좋은 대청도 해변. 볼거리, 여행 팁, 백과사전식 정보와 방문 후기를 확인하세요.",
};
  ...
  return (
    <main className="min-h-screen bg-slate-50 text-gray-900">
      ...
      <section className="relative h-[62vh] min-h-[480px] w-full overflow-hidden">
        <img src="/images/jiduri-beach.png" alt="대청도 지두리해변" className="h-full w-full object-cover" />
        ...
        <div className="absolute inset-x-0 bottom-0 mx-auto max-w-6xl px-6 pb-12 text-white">
          ...
          <h1 className="text-5xl font-black tracking-tight md:text-7xl">지두리해변</h1>
          <p className="mt-5 max-w-3xl text-lg leading-8 text-white/90 md:text-xl">부드러운 모래사장과 파도 풍경을 가까이에서 즐기기 좋은 대청도 해변</p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl space-y-8 px-6 pb-16">
        <div className="rounded-[2rem] bg-white p-8 shadow-sm md:p-10">
          ...
          <h2 className="mt-2 text-3xl font-black md:text-4xl">🌊 지두리해변은 어떤 곳인가요?</h2>
          <p className="mt-6 text-[17px] leading-8 text-gray-700">부드러운 모래사장과 파도 풍경을 가까이에서 즐기기 좋은 대청도 해변.</p>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="rounded-[2rem] bg-white p-8 shadow-sm">
            ...
            <ul className="mt-5 space-y-4 leading-7 text-gray-700">
              <li>• 넓은 모래사장</li><li>• 잔잔하게 이어지는 파도</li><li>• 해안 산책 풍경</li>
            </ul>
          </div>
          <div className="rounded-[2rem] bg-white p-8 shadow-sm">
            <h2 className="text-2xl font-black">🥾 방문 팁</h2>
            <ul className="mt-5 space-y-4 leading-7 text-gray-700">
              <li>• 물때와 파도 상황을 확인하세요.</li><li>• 젖은 바위나 해안 가장자리에서는 미끄럼에 주의하세요.</li><li>• 자연환경을 보호하며 이용해 주세요.</li>
            </ul>
          </div>
        </div>
        ...
        <div className="rounded-[2rem] bg-white p-8 shadow-sm md:p-10">
          ...
          <div className="mt-8 space-y-6 text-gray-700">
            <div><h3 className="text-lg font-bold">Q. 지두리해변은 사진 찍기 좋은가요?</h3><p className="mt-2 leading-7">네. 대청도의 자연 풍경을 배경으로 여행 사진을 남기기 좋습니다. 날씨와 시간대에 따라 풍경이 달라집니다.</p></div>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <Link href="/place/moraeul-beach" className="rounded-3xl bg-white p-6 font-extrabold shadow-sm hover:shadow-md">← 모래울해변</Link>
          <Link href="/place/dapdong-beach" className="rounded-3xl bg-gray-900 p-6 text-right font-extrabold text-white shadow-sm hover:shadow-md">답동해변 →</Link>
        </div>
      </section>
